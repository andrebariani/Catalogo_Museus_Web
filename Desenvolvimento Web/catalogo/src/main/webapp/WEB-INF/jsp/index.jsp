            ...
            <div class="row featurette">
                <div class="col-md-7">
                    ...
                    <p class="lead text-justify">O CNM é a maior e mais confiável fonte de informações sobre
                        museus disponível na internet. Catalogados na plataforma estão milhares de museus espalhados
                        pelo
                    ...
                    <p class="lead text-justify">No CNM, você pode consultar endereços, telefones, preços, tipos de
                        exposição e outras informações sobre o seu próximo destino cultural. Descubra os principais
                        museus
                        próximos de você, exposições incríveis e o oceano de cultura que os mais diversificados museus
                        do
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Museu do Futebol<h4>
                                    ...
                                    <p class="card-text">Museu interativo localizado embaixo das arquibancadas do
                                        Pacaembú, em São Paulo</p>
                                    <h6 class="card-subtitle my-2 text-muted">Horário de funcionamento:</h6>
                                    <ul class="list-group">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Museu do Amanhã<h4>
                                    ...
                                    <p class="card-text">Localizado ao lado da praia Mauá, conta com uma exposição
                                        digital</p>
                                    <h6 class="card-subtitle my-2 text-muted">Horário de funcionamento:</h6>
                                    <ul class="list-group">
