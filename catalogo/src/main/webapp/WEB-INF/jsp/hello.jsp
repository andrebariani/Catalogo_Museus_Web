    ...
    <main role="main">
        ...
        <div class="container marketing">
            ...
            <div class="row featurette">
                <div class="col-md-7">
                    <h2 class="featurette-heading">Bem-vindo ao Catálogo Nacional de Museus(CNM)!<h3><span
                                class="text-muted">O CNM é a maior e mais confiável fonte de informaçõe sobre museus
                                disponível na internet.</span></h3>
                    </h2>
                    <p class="lead text-justify">Catalogados na plataforma estão milhares de museus espalhados pelo
                        país, dentre eles alguns dos mais importantes da América latina.
                        No CNM, você pode consultar endereços, telefones, preços, tipos de exposição e outras
                        informações sobre o seu próximo destino cultural. Descubra os principais museus próximos de
                        você, exposições incríveis e o oceano de cultura que os mais
